...
const WalletStepConnecting = ({ appIcon, info, onBack, onComplete, }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(Wrapper, { children: (0, jsx_runtime_1.jsxs)(ConnectingWrapper, { children: [error ? ((0, jsx_runtime_1.jsxs)(ConnectingHeader, { children: [(0, jsx_runtime_1.jsx)(Connecting, { children: t("modal.walletStepConnecting.error.header", "Error Connecting Wallet") }, void 0), (0, jsx_runtime_1.jsx)(ConnectingInstructions, { children: error }, void 0), (0, jsx_runtime_1.jsx)(ConnectingInstructions, { children: (0, jsx_runtime_1.jsx)("a", Object.assign({ css: (0, react_1.css) `
                ...
                `, href: "#", onClick: (e) => {
                                    ...
                                    e.preventDefault();
                                    void doActivate();
                                } }, { children: t("buttons.retry", "Retry") }), void 0) }, void 0)] }, void 0)) : ((0, jsx_runtime_1.jsxs)(ConnectingHeader, { children: [(0, jsx_runtime_1.jsx)(Connecting, { children: t("modal.walletStepConnecting.connecting.header", "Connecting...") }, void 0), isManualConnect ? ((0, jsx_runtime_1.jsxs)(ConnectingInstructions, { children: ["Please", " ", (0, jsx_runtime_1.jsx)("a", Object.assign({ css: (0, react_1.css) `
                    color: #696969;
                    font-weight: bold;
                  `, href: "#", onClick: (e) => {
                                        e.stopPropagation();
                                ...
                                } }, { children: t("buttons.goBack", "Go Back") }), void 0)] }, void 0) }, void 0)] }, void 0) }, void 0));
};
