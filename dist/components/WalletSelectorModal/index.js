...
const WalletSelectorModal = (_a) => {
    var { app, onWalletKitError = defaultOnWalletKitError, initialStep = ModalStep.Intro, langOption } = _a, modalProps = __rest(_a, ["app", "onWalletKitError", "initialStep", "langOption"]);
