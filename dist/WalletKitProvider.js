...
const WalletKitProvider = (_a) => {
    var { children, app, langOption, initialStep = WalletSelectorModal_1.ModalStep.Intro } = _a, solanaProviderArgs = __rest(_a, ["children", "app", "langOption", "initialStep"]);
